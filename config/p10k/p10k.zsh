# Generated by Powerlevel10k configuration wizard on 2023-05-06 at 14:23 BST.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern|kubeseal|skaffold|kubent|kubecolor|just'
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_BACKGROUND=26
  typeset -g POWERLEVEL9K_KUBECONTEXT_PRD_FOREGROUND=0
  typeset -g POWERLEVEL9K_KUBECONTEXT_PRD_BACKGROUND=160
  typeset -g POWERLEVEL9K_KUBECONTEXT_STG_FOREGROUND=0
  typeset -g POWERLEVEL9K_KUBECONTEXT_STG_BACKGROUND=118
